...
credentials_mapbox <- "?access_token=pk.eyJ1IjoicXRodXJpZXIiLCJhIjoiY2l0MG1lNTJyMG5hYTJ5a2hvZDg4MDhrciJ9.o5-42yBAddr0QW57I3Zt6w"
tiles_mapbox <- "https://api.mapbox.com/styles/v1/mapbox/streets-v10/tiles/256/{z}/{x}/{y}"

credential_here <- "&app_id=5pZnXwF6fCPsS5W7EC1t&app_code=SbTCjJ7X_Zr-_Rod9Y8w4Q"
...
credential_google_places <- "&key=AIzaSyA0rNvyGwYEkgDOnYywGqFJ6jcGSNORypM"
